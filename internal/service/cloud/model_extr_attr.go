...
func ExpandExtAttr(ctx context.Context, tfMap types.Map, diags *diag.Diagnostics) *map[string]cloud.ExtAttrs {
	if tfMap.IsNull() || tfMap.IsUnknown() {
		return nil
	}

	result := make(map[string]cloud.ExtAttrs)
...
func (m *ExtAttrModel) Expand(ctx context.Context, diags *diag.Diagnostics) *cloud.ExtAttrs {
	if m == nil {
		return nil
	}
	to := &cloud.ExtAttrs{
...
func FlattenExtAttr(ctx context.Context, input map[string]cloud.ExtAttrs, diags *diag.Diagnostics) types.Map {
...
func (m *ExtAttrModel) Flatten(ctx context.Context, from *cloud.ExtAttrs, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
...
func RemoveInheritedExtAttrs(ctx context.Context, planExtAttrs types.Map, respExtAttrs map[string]cloud.ExtAttrs) (*map[string]cloud.ExtAttrs, diag.Diagnostics) {
	var diags diag.Diagnostics
	newRespMap := make(map[string]cloud.ExtAttrs, len(respExtAttrs))
