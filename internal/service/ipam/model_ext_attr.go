...
func ExpandExtAttr(ctx context.Context, extattrs types.Map, diags *diag.Diagnostics) *map[string]ipam.ExtAttrs {
...
func FlattenExtAttr(ctx context.Context, extattrs map[string]ipam.ExtAttrs, diags *diag.Diagnostics) types.Map {
