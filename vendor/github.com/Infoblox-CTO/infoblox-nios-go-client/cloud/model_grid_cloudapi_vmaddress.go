...
type GridCloudapiVmaddress struct {
	...
	AssociatedObjects []map[string]interface{}        `json:"associated_objects,omitempty"`
...
// SetAssociatedObjects gets a reference to the given []map[string]interface{} and assigns it to the AssociatedObjects field.
