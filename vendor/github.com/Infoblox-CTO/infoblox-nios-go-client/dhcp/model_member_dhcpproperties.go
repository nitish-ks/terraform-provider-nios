...
type MemberDhcpproperties struct {
	...
	ClearNacAuthCache map[string]interface{} `json:"clear_nac_auth_cache,omitempty"`
	...
	PurgeIfmapData   map[string]interface{} `json:"purge_ifmap_data,omitempty"`
...
// GetClearNacAuthCache returns the ClearNacAuthCache field value if set, zero value otherwise.
func (o *MemberDhcpproperties) GetClearNacAuthCache() map[string]interface{} {
	if o == nil || IsNil(o.ClearNacAuthCache) {
		var ret map[string]interface{}
		return ret
	}
	return o.ClearNacAuthCache
}

// GetClearNacAuthCacheOk returns a tuple with the ClearNacAuthCache field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetClearNacAuthCacheOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.ClearNacAuthCache) {
		return map[string]interface{}{}, false
	}
	return o.ClearNacAuthCache, true
}

// HasClearNacAuthCache returns a boolean if a field has been set.
func (o *MemberDhcpproperties) HasClearNacAuthCache() bool {
	if o != nil && !IsNil(o.ClearNacAuthCache) {
		return true
	}
...
// SetClearNacAuthCache gets a reference to the given map[string]interface{} and assigns it to the ClearNacAuthCache field.
func (o *MemberDhcpproperties) SetClearNacAuthCache(v map[string]interface{}) {
	o.ClearNacAuthCache = v
}
...
func (o *MemberDhcpproperties) GetGssTsigKeys() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetGssTsigKeysOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.GssTsigKeys) {
		return nil, false
	}
...
func (o *MemberDhcpproperties) SetGssTsigKeys(v []map[string]interface{}) {
	o.GssTsigKeys = v
}
...
func (o *MemberDhcpproperties) GetIpv6GssTsigKeys() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetIpv6GssTsigKeysOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Ipv6GssTsigKeys) {
		return nil, false
	}
...
func (o *MemberDhcpproperties) SetIpv6GssTsigKeys(v []map[string]interface{}) {
	o.Ipv6GssTsigKeys = v
}
...
// GetPurgeIfmapData returns the PurgeIfmapData field value if set, zero value otherwise.
func (o *MemberDhcpproperties) GetPurgeIfmapData() map[string]interface{} {
	if o == nil || IsNil(o.PurgeIfmapData) {
		var ret map[string]interface{}
		return ret
	}
	return o.PurgeIfmapData
}

// GetPurgeIfmapDataOk returns a tuple with the PurgeIfmapData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetPurgeIfmapDataOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PurgeIfmapData) {
		return map[string]interface{}{}, false
	}
	return o.PurgeIfmapData, true
}

// HasPurgeIfmapData returns a boolean if a field has been set.
func (o *MemberDhcpproperties) HasPurgeIfmapData() bool {
	if o != nil && !IsNil(o.PurgeIfmapData) {
		return true
	}
...
// SetPurgeIfmapData gets a reference to the given map[string]interface{} and assigns it to the PurgeIfmapData field.
func (o *MemberDhcpproperties) SetPurgeIfmapData(v map[string]interface{}) {
	o.PurgeIfmapData = v
}
...
func (o MemberDhcpproperties) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClearNacAuthCache) {
		toSerialize["clear_nac_auth_cache"] = o.ClearNacAuthCache
	}
	...
	if !IsNil(o.PurgeIfmapData) {
		toSerialize["purge_ifmap_data"] = o.PurgeIfmapData
	}
