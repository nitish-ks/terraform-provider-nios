...
func (o *MemberDhcpproperties) GetLeaseScavengeTime() string {
...
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetLeaseScavengeTimeOk() (*string, bool) {
	if o == nil || IsNil(o.LeaseScavengeTime) {
		return nil, false
	}
...
func (o *MemberDhcpproperties) SetLeaseScavengeTime(v string) {
