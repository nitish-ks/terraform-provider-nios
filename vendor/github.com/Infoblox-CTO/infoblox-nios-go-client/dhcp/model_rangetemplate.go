...
func (o *Rangetemplate) GetLeaseScavengeTime() string {
...
// and a boolean to check if the value has been set.
func (o *Rangetemplate) GetLeaseScavengeTimeOk() (*string, bool) {
	if o == nil || IsNil(o.LeaseScavengeTime) {
		return nil, false
	}
...
func (o *Rangetemplate) SetLeaseScavengeTime(v string) {
