...
func (o *Networkcontainer) GetLeaseScavengeTime() string {
...
// and a boolean to check if the value has been set.
func (o *Networkcontainer) GetLeaseScavengeTimeOk() (*string, bool) {
	if o == nil || IsNil(o.LeaseScavengeTime) {
		return nil, false
	}
...
func (o *Networkcontainer) SetLeaseScavengeTime(v string) {
