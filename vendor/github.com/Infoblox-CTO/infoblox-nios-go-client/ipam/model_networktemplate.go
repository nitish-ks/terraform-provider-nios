...
func (o *Networktemplate) GetLeaseScavengeTime() string {
...
// and a boolean to check if the value has been set.
func (o *Networktemplate) GetLeaseScavengeTimeOk() (*string, bool) {
	if o == nil || IsNil(o.LeaseScavengeTime) {
		return nil, false
	}
...
func (o *Networktemplate) SetLeaseScavengeTime(v string) {
