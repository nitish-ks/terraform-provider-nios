...
type Authpolicy struct {
	...
	AuthServices []map[string]interface{} `json:"auth_services,omitempty"`
...
// SetAuthServices gets a reference to the given []map[string]interface{} and assigns it to the AuthServices field.
