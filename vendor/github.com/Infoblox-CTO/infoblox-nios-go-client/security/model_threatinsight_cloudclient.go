...
type ThreatinsightCloudclient struct {
	...
	BlacklistRpzList []map[string]interface{} `json:"blacklist_rpz_list,omitempty"`
...
// SetBlacklistRpzList gets a reference to the given []map[string]interface{} and assigns it to the BlacklistRpzList field.
